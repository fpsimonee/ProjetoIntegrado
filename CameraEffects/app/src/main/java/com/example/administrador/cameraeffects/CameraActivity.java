package com.example.administrador.cameraeffects;
...
public class CameraActivity extends ActionBarActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    // Trecho de c�digo importado do projeto do OpenCV
    ...
    /* Primeira vers�o do C�digo sem o OPENCV
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        switch (CameraActivity.viewMode) {
            ...
            case CameraActivity.VIEW_MODE_HIST:
                Mat hist = new Mat();
            ...
            case CameraActivity.VIEW_MODE_SOBEL:
            ...
            case CameraActivity.VIEW_MODE_SEPIA:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
                Core.transform(rgbaInnerWindow, rgbaInnerWindow, mSepiaKernel);
                rgbaInnerWindow.release();
                break;

            case CameraActivity.VIEW_MODE_ZOOM:
            ...
            case CameraActivity.VIEW_MODE_PIXELIZE:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
            ...
            case CameraActivity.VIEW_MODE_POSTERIZE:
            /*
